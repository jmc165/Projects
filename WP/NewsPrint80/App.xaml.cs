...
namespace NewsPrint80
{
    public partial class App : Application
    {
        ...
        public const string LAST_PIVOT_PAGE_KEY = "LastPivotPage";
        public const string LOCATION_SERVICES_KEY = "LocationServices";
        public const string LAST_SELECTED_SEARCH_COUNTRY_KEY = "LastSelectedSearchCountry";
        public const string WEBSITE_STYLE_KEY = "WebsiteStyle";                 // mobile or desktop
 
        private static MainViewModel mMainViewModel = null;
        ...
        {
            if (App.MainViewModel.LoadSettingsKey(App.LOCATION_SERVICES_KEY) == null)
            {
            ...
            if (App.MainViewModel.LoadSettingsKey(App.WEBSITE_STYLE_KEY) == null)
                App.MainViewModel.SaveSettingsKey(App.WEBSITE_STYLE_KEY, "Mobile");
